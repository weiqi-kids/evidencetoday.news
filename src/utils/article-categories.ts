...
const ARTICLE_CATEGORY_OVERRIDES: Record<string, ArticleCategorySlug> = {
  ...
  'holiday-home-food-safety-management.mdx': 'food-safety',
  'diet-for-oral-dental-health-after-60.mdx': 'oral-hygiene',
  'nmn-anti-aging-expectations-reality.mdx': 'health-myths',
  'gaba-sleep-stress-evidence.mdx': 'sleep-stress',
  'menopause-supplements-what-works.mdx': 'menopause',
  'coq10-beyond-heart-disease-after-40.mdx': 'basic-nutrition',
  'curcumin-anticancer-claims-myth.mdx': 'health-myths',
  'supplement-felt-effect-vs-efficacy.mdx': 'health-concepts',
  'stem-cell-supplements-pseudoscience.mdx': 'health-myths',
  'maca-libido-myth-vs-evidence.mdx': 'health-myths',
  'coffee-healthy-or-not-wrong-question.mdx': 'health-concepts',
  'dose-makes-the-poison-nutrient-amount.mdx': 'health-concepts',
  'resveratrol-anti-aging-myth-reality.mdx': 'antioxidant',
  'krill-oil-vs-fish-oil-comparison.mdx': 'health-myths',
  'astaxanthin-antioxidant-hype-vs-evidence.mdx': 'antioxidant',
  'berberine-natural-ozempic-myth.mdx': 'health-myths',
  'supplement-gummies-dosage-accuracy.mdx': 'health-concepts',
  'sleep-supplements-find-root-cause.mdx': 'sleep-stress',
  'creatine-after-40-not-just-for-gym.mdx': 'basic-nutrition',
  'sialic-acid-brain-health-bird-nest-marketing.mdx': 'health-myths',
  'inositol-pcos-anxiety-insomnia.mdx': 'sleep-stress',
  'aging-starts-when-you-stop-chewing.mdx': 'oral-hygiene',
};
