...
【YMYL 鐵則】台灣繁體中文、禁中國用語、無醫療承諾/具體醫療建議、禁聳動；tags 禁含「/」。
【統一去 AI 味禁用句型（8 類，權威清單見 docs/content-guide.md「鐵則」，各生成端一致）】① 禁「不是X，而是Y」下定義與「不僅…更/還」「不只是…而是/更是」「並非…而是」排比（要對比用「是Y，而非X」）；② 禁「值得注意的是/值得一提的是/換句話說」；③ 禁空泛收束（總的來說/綜上所述/總而言之/歸根結底/整體而言）；④ 禁「真正的問題/關鍵是…」拔高與「隨著…的發展/普及」「在…的今天」開場公式；⑤ 禁「至關重要/不可或缺/舉足輕重」；⑥ 禁模糊引用（研究顯示/有研究指出/專家認為/學者認為/普遍認為）——要嘛附具體可點來源、要嘛不寫（YMYL 醫療尤其嚴）；⑦ 禁用破折號（——）下定義；⑧ 禁模板化第一人稱開場（以「我」起句、我一直覺得/我最近/老實講/朋友最常問我/最近有讀者/我發現/我觀察）。**開頭第一句直接給具體價值。**
【正向】長短句交錯、每段換開法、每段至少一個具體事實、台灣口語、容許口語瑕疵。
