...
case "$TYPE" in
  ...
  articles)
    SELECT_BLOCK="撰寫常青文章內容（collection=articles）。**動筆前先讀 docs/playbooks/winning-article-formula.md（能贏的文章模子）**，再依 docs/content-guide.md 與既有篇章慣例撰寫。**選題鐵律：每篇題目必須同時具備該 playbook 的六基因**（①單一具體決定 ②「現在」觸發點 ③台灣在地限定 ④權威站沒寫的角度 ⑤切身後果 ⑥答案先行＋範圍狠收）；六基因不全就退化成排不上去的百科泛論、寧可不寫。**選題第一順位＝擴寫已有牽引力的主題叢集**：先 node scripts/audience-insights.mjs 讀三桶、並對照已有曝光/排名的主題（如 melatonin 等目前流量引擎），把單點頁擴成「主題叢集」（補相鄰子題、強化彼此內鏈）——但每個子題都要獨立通過六基因，別為湊叢集寫泛論。新題循 playbook 的選題法（進口/合法性、保健品×藥物交互作用、某關卡前要不要停、選錯有後果的二選一）。輔助訊號：近 7 天排名 5–15 且有曝光的 query 看前 3 名競品缺口。**只做常青內容、不要寫成新聞稿**；標題用讀者會打的問句而非名詞短語；列既有檔用 ls/Glob 勿 Read 目錄、避免與既有 slug 重複。本輪挑 1–2 個最高 ROI 主題成篇（寧少勿濫，YMYL）。" ;;
  ingredients)
